"""Comprehensive logging infrastructure for mtop."""
...
class StructuredLogger:
    ...
    def with_context(self, **kwargs: Any) -> "StructuredLogger":
        ...
        new_logger = StructuredLogger(self.name, structured=self.structured)
...
def configure_logging(
    level: str = "INFO", log_file: Optional[Union[str, Path]] = None, structured: bool = True
) -> None:
