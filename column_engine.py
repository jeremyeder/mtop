...
from config_loader import Config, ColumnConfig, ColorThreshold
...
class ColumnEngine:
    ...
    def __init__(self, config: Config):
        if not RICH_AVAILABLE:
            raise ImportError("Rich library is required for column display. Install with: pip install rich")
