...
from kubectl_ld.interfaces import Logger, FileSystem, KubernetesClient
from kubectl_ld.container import Container, get_container
from kubectl_ld.implementations import LocalFileSystem, MockKubernetesClient
from kubectl_ld.async_cli import AsyncKubectlLD, AsyncResourceMonitor
from kubectl_ld.logging import StructuredLogger, OperationLogger
from kubectl_ld.cache import LRUCache, AsyncCache, CacheManager
...
class TestAsyncOperations:
    ...
    async def test_resource_monitor(self) -> None:
        ...
        mock_kubectl_ld.list_crs.return_value = [
