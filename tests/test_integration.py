"""Integration tests for mtop end-to-end workflows."""
...
class TestIntegration:
    ...
    @pytest.fixture
    def cli_path(self):
        """Path to the mtop CLI."""
        return str(Path(__file__).parent.parent / "mtop-main")
...
"""
    ...
    def run_cli(self, cli_path, args, env=None):
        ...
        result = subprocess.run(
            [sys.executable, cli_path] + args, env=env, capture_output=True, text=True
        )
        return result
