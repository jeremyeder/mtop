...
class TestSpikePattern:
    ...
    def test_valid_spike_pattern(self):
        ...
        spike = SpikePattern(magnitude=3.5, ramp_time=30.0, duration=120.0, cooldown_time=60.0)
    ...
    def test_spike_pattern_validation(self):
        ...
        with pytest.raises(ValueError, match="Jitter factor must be 0-1"):
            SpikePattern(
                magnitude=2.0, ramp_time=30.0, duration=120.0, cooldown_time=60.0, jitter_factor=1.5
            )
...
class TestIntegration:
    ...
    def test_concurrent_events(self):
        ...
        assert (
            qps > 150
        )  # Should be above baseline due to combined effects (adjusted for realistic expectations)
