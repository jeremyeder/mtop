...
class TestCostOptimizer:
    ...
    def test_cost_metrics_recording(self, cost_optimizer):
        ...
        gpu_metrics = {
            "gpu-0": GPUMetrics(
                gpu_id="gpu-0", utilization_percent=75.0, vram_used_gb=40.0, vram_total_gb=80.0
            )
        }
    ...
    def test_gpu_type_optimization_analysis(self, cost_optimizer):
        ...
        cost_optimizer.gpu_cost_efficiency = {"gpu-0": 0.8, "gpu-1": 0.6}
    ...
    def test_workload_consolidation_analysis(self, cost_optimizer):
        ...
        consolidation_found = any(
            opt.strategy == CostEfficiencyStrategy.WORKLOAD_CONSOLIDATION for opt in opportunities
        )
        assert (
            consolidation_found or len(opportunities) == 0
        )  # Depends on specific cost differences
    ...
    def test_tradeoff_analysis(self, cost_optimizer):
        ...
        current_metrics = {"ttft_p95": 450.0, "throughput": 1100.0, "error_rate": 0.08}
...
class TestIntegration:
    ...
    def test_end_to_end_optimization_cycle(self):
        ...
        current_metrics = {"ttft_p95": 480.0, "throughput": 1050.0, "error_rate": 0.08}
